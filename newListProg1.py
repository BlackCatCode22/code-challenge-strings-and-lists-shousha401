...
#
# Python file name: newListProg1
#
# Date: sep9
#
# Programmer's name: Eslam Shousha
...
# TODO: Use the string function lower() to change str_cat to all lowercase and store the result
# in a variable named str_cat_lower. Output str_cat_lower.
str_cat_lower = str_cat.lower()
print("\n str_cat_lower in lowercase is: " + str_cat_lower)

# TODO: Use the string function upper() to change str_cat to all uppercase and store the result
# in a variable named str_cat_upper. Output str_cat_upper.
str_cat_upper = str_cat.upper()
print("\n str_cat_upper in uppercase is: " + str_cat_upper)
...
# TODO: Use String Slicing to extract the string "black dog" from str_two. Store the extracted string
# in a variable named substring. Output substring.
substring = str_two[start_index:start_index + len("black dog")]
...
# TODO: Modify list_sorted. Use remove to remove the first occurrence of "Alice" Hint: list_sorted.remove("Alice")
# Output the list.
